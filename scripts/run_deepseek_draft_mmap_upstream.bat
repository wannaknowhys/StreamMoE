...
rem    - ctx 1048576 (full), agentic temp=1.0 top_p=0.95, default KV
...
set BIN=build\upstream\llama-build\bin\llama-server.exe
set PORT=8993
...
echo Loading DeepSeek-V4-Flash + draft (no-warmup, ctx 1M, metrics) ...
