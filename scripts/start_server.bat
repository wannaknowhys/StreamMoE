...
echo  - MODEL = %MODEL%
echo ===================================================================
build\main\llama-build\bin\llama-server.exe -m "%MODEL%" --host 127.0.0.1 --port %PORT% -c 1048576 -t 16 --temp 1.0 --top-p 0.95 --n-predict 384000 --cache-type-k q8_0 --cache-type-v q8_0 --no-webui %*
endlocal
